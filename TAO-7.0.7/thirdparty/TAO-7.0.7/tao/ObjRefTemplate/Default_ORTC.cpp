...
void
TAO::Value_Traits<TAO_Default_ORT::ObjectReferenceTemplate>::add_ref (TAO_Default_ORT::ObjectReferenceTemplate * p)
{
  ::CORBA::add_ref (p);
}

void
TAO::Value_Traits<TAO_Default_ORT::ObjectReferenceTemplate>::remove_ref (TAO_Default_ORT::ObjectReferenceTemplate * p)
{
  ::CORBA::remove_ref (p);
}

void
TAO::Value_Traits<TAO_Default_ORT::ObjectReferenceTemplate>::release (TAO_Default_ORT::ObjectReferenceTemplate * p)
{
  ::CORBA::remove_ref (p);
}
...
const char *
TAO_Default_ORT::ObjectReferenceTemplate::_tao_obv_repository_id () const
{
...
OBV_TAO_Default_ORT::ObjectReferenceTemplate::ObjectReferenceTemplate ()
...
void
OBV_TAO_Default_ORT::ObjectReferenceTemplate::truncation_hook ()
{

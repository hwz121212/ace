...
#ifndef _TAO_PIDL_OBJECTREFERENCETEMPLATEC_FGT1PN_H_
#define _TAO_PIDL_OBJECTREFERENCETEMPLATEC_FGT1PN_H_
...
#define _PORTABLEINTERCEPTOR_OBJECTREFERENCEFACTORY__VAR_OUT_CH_
  ...
  using ObjectReferenceFactory_var = TAO_Value_Var_T<ObjectReferenceFactory>;
  using ObjectReferenceFactory_out = TAO_Value_Out_T<ObjectReferenceFactory>;
  ...
  public:
    ...
    using _ptr_type = ObjectReferenceFactory*;
    using _var_type = ObjectReferenceFactory_var;
    using _out_type = ObjectReferenceFactory_out;
...
typedef ::TAO_VarSeq_Var_T<ObjectReferenceTemplateSeq> ObjectReferenceTemplateSeq_var;
typedef ::TAO_Seq_Out_T<ObjectReferenceTemplateSeq> ObjectReferenceTemplateSeq_out;
...
{
public:
  ObjectReferenceTemplateSeq () = default;
  ...
  ObjectReferenceTemplateSeq (const ObjectReferenceTemplateSeq &) = default;
  ObjectReferenceTemplateSeq (ObjectReferenceTemplateSeq &&) = default;
  ObjectReferenceTemplateSeq& operator= (const ObjectReferenceTemplateSeq &) = default;
  ObjectReferenceTemplateSeq& operator= (ObjectReferenceTemplateSeq &&) = default;
  virtual ~ObjectReferenceTemplateSeq () = default;
  
  // TAO_IDL - Generated from
  // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

  
  using _var_type = ObjectReferenceTemplateSeq_var;
  using _out_type = ObjectReferenceTemplateSeq_out;

...
// TAO_IDL - Generated from
// d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_visitor_valuebox\valuebox_cs.cpp:51



void
TAO::Value_Traits<CORBA::StringValue>::add_ref (CORBA::StringValue * p)
{
  ::CORBA::add_ref (p);
}

void
TAO::Value_Traits<CORBA::StringValue>::remove_ref (CORBA::StringValue * p)
{
  ::CORBA::remove_ref (p);
}

void
TAO::Value_Traits<CORBA::StringValue>::release (CORBA::StringValue * p)
{
  ::CORBA::remove_ref (p);
}
...
const char *
CORBA::StringValue::_tao_obv_repository_id () const
{
...
// TAO_IDL - Generated from
// d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_visitor_valuebox\valuebox_cs.cpp:630
...
void
TAO::Value_Traits<CORBA::WStringValue>::add_ref (CORBA::WStringValue * p)
{
  ::CORBA::add_ref (p);
}

void
TAO::Value_Traits<CORBA::WStringValue>::remove_ref (CORBA::WStringValue * p)
{
  ::CORBA::remove_ref (p);
}

void
TAO::Value_Traits<CORBA::WStringValue>::release (CORBA::WStringValue * p)
{
  ::CORBA::remove_ref (p);
}
...
const char *
CORBA::WStringValue::_tao_obv_repository_id () const
{
  return this->_tao_obv_static_repository_id ();
}
...
// TAO_IDL - Generated from
// d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_visitor_valuebox\cdr_op_cs.cpp:40

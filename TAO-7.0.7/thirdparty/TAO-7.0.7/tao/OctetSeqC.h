...
#ifndef _TAO_PIDL_OCTETSEQC_XWKZ8C_H_
#define _TAO_PIDL_OCTETSEQC_XWKZ8C_H_
...
#define _CORBA_OCTETSEQ_CH_
  ...
  public:
    ...
    virtual ~OctetSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = OctetSeq_var;
    using _out_type = OctetSeq_out;

...
TAO::Objref_Traits<PortableServer::Current>::duplicate (PortableServer::Current_ptr p)
{
  return PortableServer::Current::_duplicate (p);
}

void
TAO::Objref_Traits<PortableServer::Current>::release (PortableServer::Current_ptr p)
{
  ::CORBA::release (p);
}

PortableServer::Current_ptr
TAO::Objref_Traits<PortableServer::Current>::nil ()
{
  return PortableServer::Current::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableServer::Current>::marshal (const PortableServer::Current_ptr p,TAO_OutputCDR & cdr)
{
...
::CORBA::Exception *PortableServer::Current::NoContext::_alloc ()
{
  ::CORBA::Exception *retval {};
  ACE_NEW_RETURN (retval, ::PortableServer::Current::NoContext, nullptr);
  return retval;
}

::CORBA::Exception *
PortableServer::Current::NoContext::_tao_duplicate () const
{
  ::CORBA::Exception *result {};
  ACE_NEW_RETURN (result, ::PortableServer::Current::NoContext (*this), nullptr);
  return result;
}

void PortableServer::Current::NoContext::_raise () const
{
  throw *this;
}
...
::CORBA::TypeCode_ptr PortableServer::Current::NoContext::_tao_type () const
{
...
PortableServer::Current_ptr
PortableServer::Current::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
PortableServer::Current_ptr
PortableServer::Current::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return Current::_duplicate (
      dynamic_cast<Current_ptr> (_tao_objref));
}
...
PortableServer::Current::_is_a (const char *value)
{
  if (
      ...
      std::strcmp (value, "IDL:omg.org/PortableServer/Current:2.3") == 0 ||
...
const char* PortableServer::Current::_interface_repository_id () const
{
...
namespace PortableServer
{
  ...
  ::CORBA::Boolean operator>>= (
    ...
    const ::PortableServer::Current::NoContext *&_tao_elem)
  {
    return TAO::Any_Dual_Impl_T< ::PortableServer::Current::NoContext>::extract (
      _tao_any,
      ::PortableServer::Current::NoContext::_tao_any_destructor,
      ::PortableServer::Current::_tc_NoContext,
      _tao_elem);

...
#ifndef _TAO_PIDL_SERVANTLOCATORC_4ZGMDK_H_
#define _TAO_PIDL_SERVANTLOCATORC_4ZGMDK_H_
...
#define _PORTABLESERVER_SERVANTLOCATOR__VAR_OUT_CH_
  ...
  using ServantLocator_ptr = ServantLocator*;
  using ServantLocator_var = TAO_Objref_Var_T<ServantLocator>;
  using ServantLocator_out = TAO_Objref_Out_T<ServantLocator>;
  ...
  public:
    ...
    using _ptr_type = ServantLocator_ptr;
    using _var_type = ServantLocator_var;
    using _out_type = ServantLocator_out;
  ...
  private:
    ...
    ServantLocator (const ServantLocator &) = delete;
    ServantLocator (ServantLocator &&) = delete;
    ServantLocator &operator= (const ServantLocator &) = delete;
    ServantLocator &operator= (ServantLocator &&) = delete;
  };
...
#define _PORTABLESERVER_SERVANTLOCATOR__TRAITS_
  ...
  {
    static ::PortableServer::ServantLocator_ptr duplicate (::PortableServer::ServantLocator_ptr p);
    static void release (::PortableServer::ServantLocator_ptr p);
    static ::PortableServer::ServantLocator_ptr nil ();
    static ::CORBA::Boolean marshal (const ::PortableServer::ServantLocator_ptr p,TAO_OutputCDR & cdr);
  };

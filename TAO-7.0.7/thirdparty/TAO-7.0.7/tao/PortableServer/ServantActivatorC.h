...
#ifndef _TAO_PIDL_SERVANTACTIVATORC_83QYII_H_
#define _TAO_PIDL_SERVANTACTIVATORC_83QYII_H_
...
#define _PORTABLESERVER_SERVANTACTIVATOR__VAR_OUT_CH_
  ...
  using ServantActivator_ptr = ServantActivator*;
  using ServantActivator_var = TAO_Objref_Var_T<ServantActivator>;
  using ServantActivator_out = TAO_Objref_Out_T<ServantActivator>;
  ...
  public:
    ...
    using _ptr_type = ServantActivator_ptr;
    using _var_type = ServantActivator_var;
    using _out_type = ServantActivator_out;
  ...
  private:
    ...
    ServantActivator (const ServantActivator &) = delete;
    ServantActivator (ServantActivator &&) = delete;
    ServantActivator &operator= (const ServantActivator &) = delete;
    ServantActivator &operator= (ServantActivator &&) = delete;
  };
...
#define _PORTABLESERVER_SERVANTACTIVATOR__TRAITS_
  ...
  {
    static ::PortableServer::ServantActivator_ptr duplicate (::PortableServer::ServantActivator_ptr p);
    static void release (::PortableServer::ServantActivator_ptr p);
    static ::PortableServer::ServantActivator_ptr nil ();
    static ::CORBA::Boolean marshal (const ::PortableServer::ServantActivator_ptr p,TAO_OutputCDR & cdr);
  };

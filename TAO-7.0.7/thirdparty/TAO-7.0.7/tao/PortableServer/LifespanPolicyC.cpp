...
TAO::Objref_Traits<PortableServer::LifespanPolicy>::duplicate (PortableServer::LifespanPolicy_ptr p)
{
  return PortableServer::LifespanPolicy::_duplicate (p);
}

void
TAO::Objref_Traits<PortableServer::LifespanPolicy>::release (PortableServer::LifespanPolicy_ptr p)
{
  ::CORBA::release (p);
}

PortableServer::LifespanPolicy_ptr
TAO::Objref_Traits<PortableServer::LifespanPolicy>::nil ()
{
  return PortableServer::LifespanPolicy::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableServer::LifespanPolicy>::marshal (const PortableServer::LifespanPolicy_ptr p,TAO_OutputCDR & cdr)
{
...
{}PortableServer::LifespanPolicy_ptr
PortableServer::LifespanPolicy::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
PortableServer::LifespanPolicy_ptr
PortableServer::LifespanPolicy::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return LifespanPolicy::_duplicate (
      dynamic_cast<LifespanPolicy_ptr> (_tao_objref));
}
...
PortableServer::LifespanPolicy::_is_a (const char *value)
{
  if (
      ...
      std::strcmp (value, "IDL:omg.org/PortableServer/LifespanPolicy:2.3") == 0 ||
...
const char* PortableServer::LifespanPolicy::_interface_repository_id () const
{

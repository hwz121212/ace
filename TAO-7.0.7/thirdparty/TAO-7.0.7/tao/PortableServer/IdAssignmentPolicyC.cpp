...
TAO::Objref_Traits<PortableServer::IdAssignmentPolicy>::duplicate (PortableServer::IdAssignmentPolicy_ptr p)
{
  return PortableServer::IdAssignmentPolicy::_duplicate (p);
}

void
TAO::Objref_Traits<PortableServer::IdAssignmentPolicy>::release (PortableServer::IdAssignmentPolicy_ptr p)
{
  ::CORBA::release (p);
}

PortableServer::IdAssignmentPolicy_ptr
TAO::Objref_Traits<PortableServer::IdAssignmentPolicy>::nil ()
{
  return PortableServer::IdAssignmentPolicy::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableServer::IdAssignmentPolicy>::marshal (const PortableServer::IdAssignmentPolicy_ptr p,TAO_OutputCDR & cdr)
{
...
{}PortableServer::IdAssignmentPolicy_ptr
PortableServer::IdAssignmentPolicy::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
PortableServer::IdAssignmentPolicy_ptr
PortableServer::IdAssignmentPolicy::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return IdAssignmentPolicy::_duplicate (
      dynamic_cast<IdAssignmentPolicy_ptr> (_tao_objref));
}
...
PortableServer::IdAssignmentPolicy::_is_a (const char *value)
{
  if (
      ...
      std::strcmp (value, "IDL:omg.org/PortableServer/IdAssignmentPolicy:2.3") == 0 ||
...
const char* PortableServer::IdAssignmentPolicy::_interface_repository_id () const
{

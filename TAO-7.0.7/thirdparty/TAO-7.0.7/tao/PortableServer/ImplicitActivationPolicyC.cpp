...
TAO::Objref_Traits<PortableServer::ImplicitActivationPolicy>::duplicate (PortableServer::ImplicitActivationPolicy_ptr p)
{
  return PortableServer::ImplicitActivationPolicy::_duplicate (p);
}

void
TAO::Objref_Traits<PortableServer::ImplicitActivationPolicy>::release (PortableServer::ImplicitActivationPolicy_ptr p)
{
  ::CORBA::release (p);
}

PortableServer::ImplicitActivationPolicy_ptr
TAO::Objref_Traits<PortableServer::ImplicitActivationPolicy>::nil ()
{
  return PortableServer::ImplicitActivationPolicy::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableServer::ImplicitActivationPolicy>::marshal (const PortableServer::ImplicitActivationPolicy_ptr p,TAO_OutputCDR & cdr)
{
...
{}PortableServer::ImplicitActivationPolicy_ptr
PortableServer::ImplicitActivationPolicy::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
PortableServer::ImplicitActivationPolicy_ptr
PortableServer::ImplicitActivationPolicy::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return ImplicitActivationPolicy::_duplicate (
      dynamic_cast<ImplicitActivationPolicy_ptr> (_tao_objref));
}
...
PortableServer::ImplicitActivationPolicy::_is_a (const char *value)
{
  if (
      ...
      std::strcmp (value, "IDL:omg.org/PortableServer/ImplicitActivationPolicy:2.3") == 0 ||
...
const char* PortableServer::ImplicitActivationPolicy::_interface_repository_id () const
{

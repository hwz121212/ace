...
TAO::Objref_Traits<PortableServer::AdapterActivator>::duplicate (PortableServer::AdapterActivator_ptr p)
{
  return PortableServer::AdapterActivator::_duplicate (p);
}

void
TAO::Objref_Traits<PortableServer::AdapterActivator>::release (PortableServer::AdapterActivator_ptr p)
{
  ::CORBA::release (p);
}

PortableServer::AdapterActivator_ptr
TAO::Objref_Traits<PortableServer::AdapterActivator>::nil ()
{
  return PortableServer::AdapterActivator::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableServer::AdapterActivator>::marshal (const PortableServer::AdapterActivator_ptr p,TAO_OutputCDR & cdr)
{
...
{}PortableServer::AdapterActivator_ptr
PortableServer::AdapterActivator::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
PortableServer::AdapterActivator_ptr
PortableServer::AdapterActivator::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return AdapterActivator::_duplicate (
      dynamic_cast<AdapterActivator_ptr> (_tao_objref));
}
...
{
  if (
      std::strcmp (value, "IDL:omg.org/PortableServer/AdapterActivator:2.3") == 0 ||
...
const char* PortableServer::AdapterActivator::_interface_repository_id () const
{

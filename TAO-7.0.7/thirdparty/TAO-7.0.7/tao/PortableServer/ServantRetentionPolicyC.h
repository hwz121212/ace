...
#ifndef _TAO_PIDL_SERVANTRETENTIONPOLICYC_IPSBNG_H_
#define _TAO_PIDL_SERVANTRETENTIONPOLICYC_IPSBNG_H_
...
#define _PORTABLESERVER_SERVANTRETENTIONPOLICY__VAR_OUT_CH_
  ...
  using ServantRetentionPolicy_ptr = ServantRetentionPolicy*;
  using ServantRetentionPolicy_var = TAO_Objref_Var_T<ServantRetentionPolicy>;
  using ServantRetentionPolicy_out = TAO_Objref_Out_T<ServantRetentionPolicy>;
  ...
  public:
    ...
    using _ptr_type = ServantRetentionPolicy_ptr;
    using _var_type = ServantRetentionPolicy_var;
    using _out_type = ServantRetentionPolicy_out;
  ...
  protected:
    ...
    virtual ~ServantRetentionPolicy () = default;
  
  private:
    // Private and unimplemented for concrete interfaces.
    ServantRetentionPolicy (const ServantRetentionPolicy &) = delete;
    ServantRetentionPolicy (ServantRetentionPolicy &&) = delete;
    ServantRetentionPolicy &operator= (const ServantRetentionPolicy &) = delete;
    ServantRetentionPolicy &operator= (ServantRetentionPolicy &&) = delete;
  };
...
#define _PORTABLESERVER_SERVANTRETENTIONPOLICY__TRAITS_
  ...
  {
    static ::PortableServer::ServantRetentionPolicy_ptr duplicate (::PortableServer::ServantRetentionPolicy_ptr p);
    static void release (::PortableServer::ServantRetentionPolicy_ptr p);
    static ::PortableServer::ServantRetentionPolicy_ptr nil ();
    static ::CORBA::Boolean marshal (const ::PortableServer::ServantRetentionPolicy_ptr p,TAO_OutputCDR & cdr);
  };

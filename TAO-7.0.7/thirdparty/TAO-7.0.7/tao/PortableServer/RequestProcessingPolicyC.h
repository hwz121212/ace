...
#ifndef _TAO_PIDL_REQUESTPROCESSINGPOLICYC_KAV9UZ_H_
#define _TAO_PIDL_REQUESTPROCESSINGPOLICYC_KAV9UZ_H_
...
#define _PORTABLESERVER_REQUESTPROCESSINGPOLICY__VAR_OUT_CH_
  ...
  using RequestProcessingPolicy_ptr = RequestProcessingPolicy*;
  using RequestProcessingPolicy_var = TAO_Objref_Var_T<RequestProcessingPolicy>;
  using RequestProcessingPolicy_out = TAO_Objref_Out_T<RequestProcessingPolicy>;
  ...
  public:
    ...
    using _ptr_type = RequestProcessingPolicy_ptr;
    using _var_type = RequestProcessingPolicy_var;
    using _out_type = RequestProcessingPolicy_out;
  ...
  protected:
    ...
    virtual ~RequestProcessingPolicy () = default;
  
  private:
    // Private and unimplemented for concrete interfaces.
    RequestProcessingPolicy (const RequestProcessingPolicy &) = delete;
    RequestProcessingPolicy (RequestProcessingPolicy &&) = delete;
    RequestProcessingPolicy &operator= (const RequestProcessingPolicy &) = delete;
    RequestProcessingPolicy &operator= (RequestProcessingPolicy &&) = delete;
  };
...
#define _PORTABLESERVER_REQUESTPROCESSINGPOLICY__TRAITS_
  ...
  {
    static ::PortableServer::RequestProcessingPolicy_ptr duplicate (::PortableServer::RequestProcessingPolicy_ptr p);
    static void release (::PortableServer::RequestProcessingPolicy_ptr p);
    static ::PortableServer::RequestProcessingPolicy_ptr nil ();
    static ::CORBA::Boolean marshal (const ::PortableServer::RequestProcessingPolicy_ptr p,TAO_OutputCDR & cdr);
  };

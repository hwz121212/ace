...
#ifndef _TAO_PIDL_SERVANTMANAGERC_YEYBLC_H_
#define _TAO_PIDL_SERVANTMANAGERC_YEYBLC_H_
...
#define _PORTABLESERVER_SERVANTMANAGER__VAR_OUT_CH_
  ...
  public:
    ...
    using _ptr_type = ServantManager_ptr;
    using _var_type = ServantManager_var;
    using _out_type = ServantManager_out;
  ...
  protected:
    ...
    virtual ~ServantManager () = default;
  
  private:
    // Private and unimplemented for concrete interfaces.
    ServantManager (const ServantManager &) = delete;
    ServantManager (ServantManager &&) = delete;
    ServantManager &operator= (const ServantManager &) = delete;
    ServantManager &operator= (ServantManager &&) = delete;
  };

...
#ifndef _TAO_PIDL_PS_CURRENTC_KZSI4X_H_
#define _TAO_PIDL_PS_CURRENTC_KZSI4X_H_
...
#define _PORTABLESERVER_CURRENT__TRAITS_
  ...
  {
    static ::PortableServer::Current_ptr duplicate (::PortableServer::Current_ptr p);
    static void release (::PortableServer::Current_ptr p);
    static ::PortableServer::Current_ptr nil ();
    static ::CORBA::Boolean marshal (const ::PortableServer::Current_ptr p,TAO_OutputCDR & cdr);
  };

...
#ifndef _TAO_PIDL_POLICY_CURRENTC_Y2DDAP_H_
#define _TAO_PIDL_POLICY_CURRENTC_Y2DDAP_H_
...
#define _CORBA_POLICYCURRENT__VAR_OUT_CH_
  ...
  public:
    ...
    using _ptr_type = PolicyCurrent_ptr;
    using _var_type = PolicyCurrent_var;
    using _out_type = PolicyCurrent_out;
  ...
  protected:
    ...
    virtual ~PolicyCurrent () = default;
  
  private:
    // Private and unimplemented for concrete interfaces.
    PolicyCurrent (const PolicyCurrent &) = delete;
    PolicyCurrent (PolicyCurrent &&) = delete;
    PolicyCurrent &operator= (const PolicyCurrent &) = delete;
    PolicyCurrent &operator= (PolicyCurrent &&) = delete;
  };

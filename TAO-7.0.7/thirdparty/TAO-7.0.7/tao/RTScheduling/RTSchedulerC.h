...
#ifndef _TAO_PIDL_RTSCHEDULERC_JFG8PR_H_
#define _TAO_PIDL_RTSCHEDULERC_JFG8PR_H_
...
#define _RTSCHEDULING_THREADACTION__VAR_OUT_CH_
  ...
  class ThreadAction;
  using ThreadAction_ptr = ThreadAction*;
  using ThreadAction_var = TAO_Objref_Var_T<ThreadAction>;
  using ThreadAction_out = TAO_Objref_Out_T<ThreadAction>;
  ...
  public:
    ...
    using _ptr_type = ThreadAction_ptr;
    using _var_type = ThreadAction_var;
    using _out_type = ThreadAction_out;
  ...
  private:
    ...
    ThreadAction (const ThreadAction &) = delete;
    ThreadAction (ThreadAction &&) = delete;
    ThreadAction &operator= (const ThreadAction &) = delete;
    ThreadAction &operator= (ThreadAction &&) = delete;
  };
  // TAO_IDL - Generated from
  // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_interface.cpp:747
...
#define _RTSCHEDULING_DISTRIBUTABLETHREAD__VAR_OUT_CH_
  ...
  using DistributableThread_ptr = DistributableThread*;
  using DistributableThread_var = TAO_Objref_Var_T<DistributableThread>;
  using DistributableThread_out = TAO_Objref_Out_T<DistributableThread>;
  ...
  public:
    ...
    using _ptr_type = DistributableThread_ptr;
    using _var_type = DistributableThread_var;
    using _out_type = DistributableThread_out;
    ...
    static DistributableThread_ptr _nil ();
    // TAO_IDL - Generated from
    ...
    virtual ::RTScheduling::DistributableThread::DT_State state () = 0;
  ...
  protected:
    ...
    virtual ~DistributableThread () = default;
  
  private:
    // Private and unimplemented for concrete interfaces.
    DistributableThread (const DistributableThread &) = delete;
    DistributableThread (DistributableThread &&) = delete;
    DistributableThread &operator= (const DistributableThread &) = delete;
    DistributableThread &operator= (DistributableThread &&) = delete;
  };
  // TAO_IDL - Generated from
  // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_interface.cpp:747
...
#define _RTSCHEDULING_CURRENT__VAR_OUT_CH_
  ...
  public:
    ...
    public:
      ...
      ~UNSUPPORTED_SCHEDULING_DISCIPLINE () = default;
...
#define _RTSCHEDULING_CURRENT_IDTYPE_CH_
    ...
    class IdType;
    typedef ::TAO_FixedSeq_Var_T<IdType> IdType_var;
    typedef ::TAO_Seq_Out_T<IdType> IdType_out;
    ...
    public:
      ...
      using _var_type = IdType_var;
      using _out_type = IdType_out;

      
#if (TAO_NO_COPY_OCTET_SEQUENCES == 1)
      IdType (::CORBA::ULong length, const ACE_Message_Block* mb)
    ...
    virtual ::RTScheduling::Current::IdType * id () = 0;

    virtual ::RTScheduling::DistributableThread_ptr lookup (
      const ::RTScheduling::Current::IdType & id) = 0;

    virtual ::CORBA::Policy_ptr scheduling_parameter () = 0;

    virtual ::CORBA::Policy_ptr implicit_scheduling_parameter () = 0;
...
#define _RTSCHEDULING_CURRENT_NAMELIST_CH_
    ...
    class NameList;
    typedef ::TAO_VarSeq_Var_T<NameList> NameList_var;
    typedef ::TAO_Seq_Out_T<NameList> NameList_out;
    ...
    public:
      ...
      using _var_type = NameList_var;
      using _out_type = NameList_out;
    };

#endif /* end #if !defined */

    virtual ::RTScheduling::Current::NameList * current_scheduling_segment_names () = 0;
...
#define _RTSCHEDULING_RESOURCEMANAGER__VAR_OUT_CH_
  ...
  using ResourceManager_ptr = ResourceManager*;
  using ResourceManager_var = TAO_Objref_Var_T<ResourceManager>;
  using ResourceManager_out = TAO_Objref_Out_T<ResourceManager>;
  ...
  public:
    ...
    using _ptr_type = ResourceManager_ptr;
    using _var_type = ResourceManager_var;
    using _out_type = ResourceManager_out;
    ...
    static ResourceManager_ptr _nil ();
...
#define _RTSCHEDULING_SCHEDULER__VAR_OUT_CH_
  ...
  public:
    ...
    public:
      ...
      ~INCOMPATIBLE_SCHEDULING_DISCIPLINES () = default;
    ...
    virtual ::CORBA::PolicyList * scheduling_policies () = 0;

    virtual void scheduling_policies (
      const ::CORBA::PolicyList & scheduling_policies) = 0;

    virtual ::CORBA::PolicyList * poa_policies () = 0;

    virtual char * scheduling_discipline_name () = 0;
...
#define _RTSCHEDULING_THREADACTION__TRAITS_
  ...
  {
    static ::RTScheduling::ThreadAction_ptr duplicate (::RTScheduling::ThreadAction_ptr p);
    static void release (::RTScheduling::ThreadAction_ptr p);
    static ::RTScheduling::ThreadAction_ptr nil ();
    static ::CORBA::Boolean marshal (const ::RTScheduling::ThreadAction_ptr p,TAO_OutputCDR & cdr);
  };
...
#define _RTSCHEDULING_DISTRIBUTABLETHREAD__TRAITS_
  ...
  {
    static ::RTScheduling::DistributableThread_ptr duplicate (::RTScheduling::DistributableThread_ptr p);
    static void release (::RTScheduling::DistributableThread_ptr p);
    static ::RTScheduling::DistributableThread_ptr nil ();
    static ::CORBA::Boolean marshal (const ::RTScheduling::DistributableThread_ptr p,TAO_OutputCDR & cdr);
  };
...
#define _RTSCHEDULING_CURRENT__TRAITS_
  ...
  {
    static ::RTScheduling::Current_ptr duplicate (::RTScheduling::Current_ptr p);
    static void release (::RTScheduling::Current_ptr p);
    static ::RTScheduling::Current_ptr nil ();
    static ::CORBA::Boolean marshal (const ::RTScheduling::Current_ptr p,TAO_OutputCDR & cdr);
  };
...
#define _RTSCHEDULING_RESOURCEMANAGER__TRAITS_
  ...
  {
    static ::RTScheduling::ResourceManager_ptr duplicate (::RTScheduling::ResourceManager_ptr p);
    static void release (::RTScheduling::ResourceManager_ptr p);
    static ::RTScheduling::ResourceManager_ptr nil ();
    static ::CORBA::Boolean marshal (const ::RTScheduling::ResourceManager_ptr p,TAO_OutputCDR & cdr);
  };
...
#define _RTSCHEDULING_SCHEDULER__TRAITS_
  ...
  {
    static ::RTScheduling::Scheduler_ptr duplicate (::RTScheduling::Scheduler_ptr p);
    static void release (::RTScheduling::Scheduler_ptr p);
    static ::RTScheduling::Scheduler_ptr nil ();
    static ::CORBA::Boolean marshal (const ::RTScheduling::Scheduler_ptr p,TAO_OutputCDR & cdr);
  };

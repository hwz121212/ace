...
#ifndef _TAO_PIDL_WSTRINGSEQC_D62XFP_H_
#define _TAO_PIDL_WSTRINGSEQC_D62XFP_H_
...
#define _CORBA_WSTRINGSEQ_CH_
  ...
  public:
    ...
    virtual ~WStringSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = WStringSeq_var;
    using _out_type = WStringSeq_out;

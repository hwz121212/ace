...
#ifndef _TAO_PIDL_ULONGSEQC_MHYHWB_H_
#define _TAO_PIDL_ULONGSEQC_MHYHWB_H_
...
#define _CORBA_ULONGSEQ_CH_
  ...
  public:
    ...
    virtual ~ULongSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = ULongSeq_var;
    using _out_type = ULongSeq_out;

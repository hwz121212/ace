...
TAO::Objref_Traits<CORBA::TypeCodeFactory>::duplicate (CORBA::TypeCodeFactory_ptr p)
{
  return CORBA::TypeCodeFactory::_duplicate (p);
}

void
TAO::Objref_Traits<CORBA::TypeCodeFactory>::release (CORBA::TypeCodeFactory_ptr p)
{
  ::CORBA::release (p);
}

CORBA::TypeCodeFactory_ptr
TAO::Objref_Traits<CORBA::TypeCodeFactory>::nil ()
{
  return CORBA::TypeCodeFactory::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<CORBA::TypeCodeFactory>::marshal (const CORBA::TypeCodeFactory_ptr p,TAO_OutputCDR & cdr)
{
...
CORBA::TypeCodeFactory_ptr
CORBA::TypeCodeFactory::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
CORBA::TypeCodeFactory_ptr
CORBA::TypeCodeFactory::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TypeCodeFactory::_duplicate (
      dynamic_cast<TypeCodeFactory_ptr> (_tao_objref));
}
...
{
  if (
      std::strcmp (value, "IDL:omg.org/CORBA/TypeCodeFactory:1.0") == 0 ||
...
const char* CORBA::TypeCodeFactory::_interface_repository_id () const
{

...
#ifndef _TAO_PIDL_DOUBLESEQC_YCMAUD_H_
#define _TAO_PIDL_DOUBLESEQC_YCMAUD_H_
...
#define _CORBA_DOUBLESEQ_CH_
  ...
  public:
    ...
    virtual ~DoubleSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = DoubleSeq_var;
    using _out_type = DoubleSeq_out;

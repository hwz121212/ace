...
TAO::Objref_Traits<PortableInterceptor::ORBInitializer>::duplicate (PortableInterceptor::ORBInitializer_ptr p)
{
  return PortableInterceptor::ORBInitializer::_duplicate (p);
}

void
TAO::Objref_Traits<PortableInterceptor::ORBInitializer>::release (PortableInterceptor::ORBInitializer_ptr p)
{
  ::CORBA::release (p);
}

PortableInterceptor::ORBInitializer_ptr
TAO::Objref_Traits<PortableInterceptor::ORBInitializer>::nil ()
{
  return PortableInterceptor::ORBInitializer::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableInterceptor::ORBInitializer>::marshal (const PortableInterceptor::ORBInitializer_ptr p,TAO_OutputCDR & cdr)
{
...
{}PortableInterceptor::ORBInitializer_ptr
PortableInterceptor::ORBInitializer::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
PortableInterceptor::ORBInitializer_ptr
PortableInterceptor::ORBInitializer::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return ORBInitializer::_duplicate (
      dynamic_cast<ORBInitializer_ptr> (_tao_objref));
}
...
{
  if (
      std::strcmp (value, "IDL:omg.org/PortableInterceptor/ORBInitializer:1.0") == 0 ||
...
const char* PortableInterceptor::ORBInitializer::_interface_repository_id () const
{

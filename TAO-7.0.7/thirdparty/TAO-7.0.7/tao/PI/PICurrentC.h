...
#ifndef _TAO_PIDL_PICURRENTC_QU1OQQ_H_
#define _TAO_PIDL_PICURRENTC_QU1OQQ_H_
...
#define _PORTABLEINTERCEPTOR_CURRENT__TRAITS_
  ...
  {
    static ::PortableInterceptor::Current_ptr duplicate (::PortableInterceptor::Current_ptr p);
    static void release (::PortableInterceptor::Current_ptr p);
    static ::PortableInterceptor::Current_ptr nil ();
    static ::CORBA::Boolean marshal (const ::PortableInterceptor::Current_ptr p,TAO_OutputCDR & cdr);
  };

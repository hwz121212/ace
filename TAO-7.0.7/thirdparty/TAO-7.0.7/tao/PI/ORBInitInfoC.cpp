...
TAO::Objref_Traits<PortableInterceptor::ORBInitInfo>::duplicate (PortableInterceptor::ORBInitInfo_ptr p)
{
  return PortableInterceptor::ORBInitInfo::_duplicate (p);
}

void
TAO::Objref_Traits<PortableInterceptor::ORBInitInfo>::release (PortableInterceptor::ORBInitInfo_ptr p)
{
  ::CORBA::release (p);
}

PortableInterceptor::ORBInitInfo_ptr
TAO::Objref_Traits<PortableInterceptor::ORBInitInfo>::nil ()
{
  return PortableInterceptor::ORBInitInfo::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableInterceptor::ORBInitInfo>::marshal (const PortableInterceptor::ORBInitInfo_ptr p,TAO_OutputCDR & cdr)
{
...
::CORBA::Exception *PortableInterceptor::ORBInitInfo::DuplicateName::_alloc ()
{
  ::CORBA::Exception *retval {};
  ACE_NEW_RETURN (retval, ::PortableInterceptor::ORBInitInfo::DuplicateName, nullptr);
  return retval;
}

::CORBA::Exception *
PortableInterceptor::ORBInitInfo::DuplicateName::_tao_duplicate () const
{
  ::CORBA::Exception *result {};
  ACE_NEW_RETURN (result, ::PortableInterceptor::ORBInitInfo::DuplicateName (*this), nullptr);
  return result;
}

void PortableInterceptor::ORBInitInfo::DuplicateName::_raise () const
{
  throw *this;
}
...
::CORBA::TypeCode_ptr PortableInterceptor::ORBInitInfo::DuplicateName::_tao_type () const
{
...
::CORBA::Exception *PortableInterceptor::ORBInitInfo::InvalidName::_alloc ()
{
  ::CORBA::Exception *retval {};
  ACE_NEW_RETURN (retval, ::PortableInterceptor::ORBInitInfo::InvalidName, nullptr);
  return retval;
}

::CORBA::Exception *
PortableInterceptor::ORBInitInfo::InvalidName::_tao_duplicate () const
{
  ::CORBA::Exception *result {};
  ACE_NEW_RETURN (result, ::PortableInterceptor::ORBInitInfo::InvalidName (*this), nullptr);
  return result;
}

void PortableInterceptor::ORBInitInfo::InvalidName::_raise () const
{
  throw *this;
}
...
// TAO extension - the virtual _type method.
::CORBA::TypeCode_ptr PortableInterceptor::ORBInitInfo::InvalidName::_tao_type () const
{
...
{}PortableInterceptor::ORBInitInfo_ptr
PortableInterceptor::ORBInitInfo::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
PortableInterceptor::ORBInitInfo_ptr
PortableInterceptor::ORBInitInfo::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return ORBInitInfo::_duplicate (
      dynamic_cast<ORBInitInfo_ptr> (_tao_objref));
}
...
PortableInterceptor::ORBInitInfo_ptr
PortableInterceptor::ORBInitInfo::_nil ()
{
  return nullptr;
}
...
{
  if (
      std::strcmp (value, "IDL:omg.org/PortableInterceptor/ORBInitInfo:1.0") == 0 ||
...
const char* PortableInterceptor::ORBInitInfo::_interface_repository_id () const
{
...
TAO::Objref_Traits<PortableInterceptor::ORBInitInfo_3_1>::duplicate (PortableInterceptor::ORBInitInfo_3_1_ptr p)
{
  return PortableInterceptor::ORBInitInfo_3_1::_duplicate (p);
}

void
TAO::Objref_Traits<PortableInterceptor::ORBInitInfo_3_1>::release (PortableInterceptor::ORBInitInfo_3_1_ptr p)
{
  ::CORBA::release (p);
}

PortableInterceptor::ORBInitInfo_3_1_ptr
TAO::Objref_Traits<PortableInterceptor::ORBInitInfo_3_1>::nil ()
{
  return PortableInterceptor::ORBInitInfo_3_1::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableInterceptor::ORBInitInfo_3_1>::marshal (const PortableInterceptor::ORBInitInfo_3_1_ptr p,TAO_OutputCDR & cdr)
{
  return ::CORBA::Object::marshal (p, cdr);
}
...
PortableInterceptor::ORBInitInfo_3_1::ORBInitInfo_3_1 ()
{}PortableInterceptor::ORBInitInfo_3_1_ptr
PortableInterceptor::ORBInitInfo_3_1::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
PortableInterceptor::ORBInitInfo_3_1_ptr
PortableInterceptor::ORBInitInfo_3_1::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return ORBInitInfo_3_1::_duplicate (
      dynamic_cast<ORBInitInfo_3_1_ptr> (_tao_objref));
}
...
PortableInterceptor::ORBInitInfo_3_1_ptr
PortableInterceptor::ORBInitInfo_3_1::_nil ()
{
  return nullptr;
}
...
PortableInterceptor::ORBInitInfo_3_1::_is_a (const char *value)
{
  if (
      std::strcmp (value, "IDL:omg.org/PortableInterceptor/ORBInitInfo:1.0") == 0 ||
      std::strcmp (value, "IDL:omg.org/PortableInterceptor/ORBInitInfo_3_1:1.0") == 0 ||
      std::strcmp (value, "IDL:omg.org/CORBA/LocalObject:1.0") == 0 ||
      std::strcmp (value, "IDL:omg.org/CORBA/Object:1.0") == 0
      )
    {
...
const char* PortableInterceptor::ORBInitInfo_3_1::_interface_repository_id () const
{

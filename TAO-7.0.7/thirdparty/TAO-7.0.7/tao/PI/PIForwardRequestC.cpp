...
::CORBA::Exception *PortableInterceptor::ForwardRequest::_alloc ()
{
  ::CORBA::Exception *retval {};
  ACE_NEW_RETURN (retval, ::PortableInterceptor::ForwardRequest, nullptr);
  return retval;
}

::CORBA::Exception *
PortableInterceptor::ForwardRequest::_tao_duplicate () const
{
  ::CORBA::Exception *result {};
  ACE_NEW_RETURN (result, ::PortableInterceptor::ForwardRequest (*this), nullptr);
  return result;
}

void PortableInterceptor::ForwardRequest::_raise () const
{
  throw *this;
}

...
#ifndef _TAO_PIDL_INTERCEPTORC_VJKUVP_H_
#define _TAO_PIDL_INTERCEPTORC_VJKUVP_H_
...
#define _PORTABLEINTERCEPTOR_INTERCEPTOR__VAR_OUT_CH_
  ...
  class Interceptor;
  using Interceptor_ptr = Interceptor*;
  using Interceptor_var = TAO_Objref_Var_T<Interceptor>;
  using Interceptor_out = TAO_Objref_Out_T<Interceptor>;
  ...
  public:
    ...
    using _ptr_type = Interceptor_ptr;
    using _var_type = Interceptor_var;
    using _out_type = Interceptor_out;
...
#define _PORTABLEINTERCEPTOR_INTERCEPTOR__TRAITS_
  ...
  {
    static ::PortableInterceptor::Interceptor_ptr duplicate (::PortableInterceptor::Interceptor_ptr p);
    static void release (::PortableInterceptor::Interceptor_ptr p);
    static ::PortableInterceptor::Interceptor_ptr nil ();
    static ::CORBA::Boolean marshal (const ::PortableInterceptor::Interceptor_ptr p,TAO_OutputCDR & cdr);
  };

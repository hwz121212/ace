...
TAO::Objref_Traits<PortableInterceptor::Interceptor>::duplicate (PortableInterceptor::Interceptor_ptr p)
{
  return PortableInterceptor::Interceptor::_duplicate (p);
}

void
TAO::Objref_Traits<PortableInterceptor::Interceptor>::release (PortableInterceptor::Interceptor_ptr p)
{
  ::CORBA::release (p);
}

PortableInterceptor::Interceptor_ptr
TAO::Objref_Traits<PortableInterceptor::Interceptor>::nil ()
{
  return PortableInterceptor::Interceptor::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<PortableInterceptor::Interceptor>::marshal (const PortableInterceptor::Interceptor_ptr p,TAO_OutputCDR & cdr)
{
...
const char* PortableInterceptor::Interceptor::_interface_repository_id () const
{

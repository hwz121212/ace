...
#ifndef _TAO_PIDL_ORBINITIALIZERC_IIM3DY_H_
#define _TAO_PIDL_ORBINITIALIZERC_IIM3DY_H_
...
#define _PORTABLEINTERCEPTOR_ORBINITIALIZER__VAR_OUT_CH_
  ...
  using ORBInitializer_ptr = ORBInitializer*;
  using ORBInitializer_var = TAO_Objref_Var_T<ORBInitializer>;
  using ORBInitializer_out = TAO_Objref_Out_T<ORBInitializer>;
  ...
  public:
    ...
    using _ptr_type = ORBInitializer_ptr;
    using _var_type = ORBInitializer_var;
    using _out_type = ORBInitializer_out;
  ...
  protected:
    ...
    virtual ~ORBInitializer () = default;
  
  private:
    // Private and unimplemented for concrete interfaces.
    ORBInitializer (const ORBInitializer &) = delete;
    ORBInitializer (ORBInitializer &&) = delete;
    ORBInitializer &operator= (const ORBInitializer &) = delete;
    ORBInitializer &operator= (ORBInitializer &&) = delete;
  };
...
#define _PORTABLEINTERCEPTOR_ORBINITIALIZER__TRAITS_
  ...
  {
    static ::PortableInterceptor::ORBInitializer_ptr duplicate (::PortableInterceptor::ORBInitializer_ptr p);
    static void release (::PortableInterceptor::ORBInitializer_ptr p);
    static ::PortableInterceptor::ORBInitializer_ptr nil ();
    static ::CORBA::Boolean marshal (const ::PortableInterceptor::ORBInitializer_ptr p,TAO_OutputCDR & cdr);
  };

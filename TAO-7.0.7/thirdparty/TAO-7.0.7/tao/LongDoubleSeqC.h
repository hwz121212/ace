...
#ifndef _TAO_PIDL_LONGDOUBLESEQC_C6UJGU_H_
#define _TAO_PIDL_LONGDOUBLESEQC_C6UJGU_H_
...
#define _CORBA_LONGDOUBLESEQ_CH_
  ...
  public:
    ...
    virtual ~LongDoubleSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = LongDoubleSeq_var;
    using _out_type = LongDoubleSeq_out;

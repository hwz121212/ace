...
#ifndef _TAO_PIDL_DYNAMICC_PVTJEG_H_
#define _TAO_PIDL_DYNAMICC_PVTJEG_H_
...
#define _DYNAMIC_PARAMETERLIST_CH_
  ...
  public:
    ...
    using _var_type = ParameterList_var;
    using _out_type = ParameterList_out;
...
#define _DYNAMIC_EXCEPTIONLIST_CH_
  ...
  public:
    ...
    virtual ~ExceptionList () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = ExceptionList_var;
    using _out_type = ExceptionList_out;

...
#ifndef _TAO_IDL_IFR_BASICS_OL8NIC_H_
#define _TAO_IDL_IFR_BASICS_OL8NIC_H_
...
namespace POA_CORBA
{
  ...
  public:
    ...
    virtual ::CORBA::ExcDescriptionSeq * get_exceptions () = 0;
    ...
    virtual ::CORBA::ExcDescriptionSeq * set_exceptions () = 0;

...
#ifndef _TAO_IDL_IFR_EXTENDEDS_T_MUDPPC_CPP_
#define _TAO_IDL_IFR_EXTENDEDS_T_MUDPPC_CPP_
...
template <class T>
POA_CORBA::FixedDef_tie<T>::~FixedDef_tie ()
{
  if (this->rel_)
    {
      delete this->ptr_;
...
template <class T> T *
POA_CORBA::FixedDef_tie<T>::_tied_object ()
{
  return this->ptr_;
}
...
POA_CORBA::FixedDef_tie<T>::_is_owner ()
{
  return this->rel_;
}
...
template <class T>
POA_CORBA::ValueMemberDef_tie<T>::~ValueMemberDef_tie ()
{
  if (this->rel_)
    {
      delete this->ptr_;
...
template <class T>  ::CORBA::Boolean
POA_CORBA::ValueMemberDef_tie<T>::_is_owner ()
{
  return this->rel_;
}
...
template <class T>
POA_CORBA::ValueDef_tie<T>::~ValueDef_tie ()
{
  if (this->rel_)
    {
      delete this->ptr_;
...
template <class T> T *
POA_CORBA::ValueDef_tie<T>::_tied_object ()
{
  return this->ptr_;
}
...
template <class T>  ::CORBA::Boolean
POA_CORBA::ValueDef_tie<T>::_is_owner ()
{
  return this->rel_;
}
...
template <class T>
POA_CORBA::ExtValueDef_tie<T>::~ExtValueDef_tie ()
{
  if (this->rel_)
    {
      delete this->ptr_;
...
template <class T> T *
POA_CORBA::ExtValueDef_tie<T>::_tied_object ()
{
  return this->ptr_;
}
...
template <class T>  ::CORBA::Boolean
POA_CORBA::ExtValueDef_tie<T>::_is_owner ()
{
  return this->rel_;
}
...
template <class T>
POA_CORBA::ValueBoxDef_tie<T>::~ValueBoxDef_tie ()
{
  if (this->rel_)
    {
      delete this->ptr_;
...
template <class T> T *
POA_CORBA::ValueBoxDef_tie<T>::_tied_object ()
{
  return this->ptr_;
}
...
template <class T>  ::CORBA::Boolean
POA_CORBA::ValueBoxDef_tie<T>::_is_owner ()
{
  return this->rel_;
}

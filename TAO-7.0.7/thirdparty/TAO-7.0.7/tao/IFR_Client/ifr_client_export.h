...
#if defined (ACE_AS_STATIC_LIBS) && !defined (TAO_IFR_CLIENT_HAS_DLL)
#  define TAO_IFR_CLIENT_HAS_DLL 0
#endif /* ACE_AS_STATIC_LIBS && TAO_IFR_CLIENT_HAS_DLL */
...
// Set TAO_IFR_CLIENT_NTRACE = 0 to turn on library-specific
// tracing even if tracing is turned off for ACE.
#if !defined (TAO_IFR_CLIENT_NTRACE)
#  if (ACE_NTRACE == 1)
#    define TAO_IFR_CLIENT_NTRACE 1
#  else /* (ACE_NTRACE == 1) */
#    define TAO_IFR_CLIENT_NTRACE 0
#  endif /* (ACE_NTRACE == 1) */
#endif /* !TAO_IFR_CLIENT_NTRACE */

#if (TAO_IFR_CLIENT_NTRACE == 1)
#  define TAO_IFR_CLIENT_TRACE(X)
#else /* (TAO_IFR_CLIENT_NTRACE == 1) */
#  if !defined (ACE_HAS_TRACE)
#    define ACE_HAS_TRACE
#  endif /* ACE_HAS_TRACE */
#  define TAO_IFR_CLIENT_TRACE(X) ACE_TRACE_IMPL(X)
#  include "ace/Trace.h"
#endif /* (TAO_IFR_CLIENT_NTRACE == 1) */

...
#ifndef _TAO_PIDL_COIOP_ENDPOINTSC_1BYDWC_H_
#define _TAO_PIDL_COIOP_ENDPOINTSC_1BYDWC_H_
...
namespace TAO
{
  ...
  using COIOP_Endpoint_Info_var = ::TAO_Var_Var_T<COIOP_Endpoint_Info>;
  using COIOP_Endpoint_Info_out = ::TAO_Out_T<COIOP_Endpoint_Info>;
  ...
  struct TAO_Strategies_Export COIOP_Endpoint_Info
  {
    ...
    using _var_type = COIOP_Endpoint_Info_var;
    using _out_type = COIOP_Endpoint_Info_out;
...
#define _TAO_COIOPENDPOINTSEQUENCE_CH_
  ...
  public:
    ...
    COIOPEndpointSequence (const COIOPEndpointSequence &) = default;
    COIOPEndpointSequence (COIOPEndpointSequence &&) = default;
    COIOPEndpointSequence& operator= (const COIOPEndpointSequence &) = default;
    COIOPEndpointSequence& operator= (COIOPEndpointSequence &&) = default;
    virtual ~COIOPEndpointSequence () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = COIOPEndpointSequence_var;
    using _out_type = COIOPEndpointSequence_out;
  };

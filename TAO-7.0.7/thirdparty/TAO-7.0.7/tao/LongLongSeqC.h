...
#ifndef _TAO_PIDL_LONGLONGSEQC_IUKBYJ_H_
#define _TAO_PIDL_LONGLONGSEQC_IUKBYJ_H_
...
#define _CORBA_LONGLONGSEQ_CH_
  ...
  public:
    ...
    virtual ~LongLongSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = LongLongSeq_var;
    using _out_type = LongLongSeq_out;

...
TAO::Transport::NoContext::NoContext ()
  : ::CORBA::UserException (
...
::CORBA::Exception *TAO::Transport::NoContext::_alloc ()
{
  ::CORBA::Exception *retval {};
  ACE_NEW_RETURN (retval, ::TAO::Transport::NoContext, nullptr);
  return retval;
}

::CORBA::Exception *
TAO::Transport::NoContext::_tao_duplicate () const
{
  ::CORBA::Exception *result {};
  ACE_NEW_RETURN (result, ::TAO::Transport::NoContext (*this), nullptr);
  return result;
}

void TAO::Transport::NoContext::_raise () const
{
  throw *this;
}
...
::CORBA::TypeCode_ptr TAO::Transport::NoContext::_tao_type () const
{
...
TAO::Objref_Traits<TAO::Transport::Current>::duplicate (TAO::Transport::Current_ptr p)
{
  return TAO::Transport::Current::_duplicate (p);
}

void
TAO::Objref_Traits<TAO::Transport::Current>::release (TAO::Transport::Current_ptr p)
{
  ::CORBA::release (p);
}

TAO::Transport::Current_ptr
TAO::Objref_Traits<TAO::Transport::Current>::nil ()
{
  return TAO::Transport::Current::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<TAO::Transport::Current>::marshal (const TAO::Transport::Current_ptr p,TAO_OutputCDR & cdr)
{
...
TAO::Transport::Current_ptr
TAO::Transport::Current::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
TAO::Transport::Current_ptr
TAO::Transport::Current::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return Current::_duplicate (
      dynamic_cast<Current_ptr> (_tao_objref));
}
...
{
  if (
      std::strcmp (value, "IDL:TAO/Transport/Current:1.0") == 0 ||
...
const char* TAO::Transport::Current::_interface_repository_id () const
{
...
namespace TAO
{
  template<>
  ::CORBA::Boolean
  Any_Dual_Impl_T<TAO::Transport::NoContext>::demarshal_value (TAO_InputCDR & cdr)
  {
    ::CORBA::String_var id;
...
namespace TAO
{
  ...
  namespace Transport
  {
    ...
    ::CORBA::Boolean operator>>= (
      ...
      const ::TAO::Transport::NoContext *&_tao_elem)
    {
      return TAO::Any_Dual_Impl_T< ::TAO::Transport::NoContext>::extract (
        _tao_any,
        ::TAO::Transport::NoContext::_tao_any_destructor,
        ::TAO::Transport::_tc_NoContext,
        _tao_elem);

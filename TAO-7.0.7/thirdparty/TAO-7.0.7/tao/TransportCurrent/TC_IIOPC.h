...
#ifndef _TAO_IDL_TC_IIOPC_4JXLBH_H_
#define _TAO_IDL_TC_IIOPC_4JXLBH_H_
...
#define _TAO_TRANSPORT_IIOP_CURRENT__VAR_OUT_CH_
      ...
      public:
        ...
        virtual ::CORBA::Long remote_port () = 0;

        virtual char * local_host () = 0;

        virtual ::CORBA::Long local_port () = 0;

        virtual ::SSLIOP::Current_ptr ssliop_current () = 0;
...
#define _SSLIOP_CURRENT__TRAITS_
  ...
  {
    static ::SSLIOP::Current_ptr duplicate (::SSLIOP::Current_ptr p);
    static void release (::SSLIOP::Current_ptr p);
    static ::SSLIOP::Current_ptr nil ();
    static ::CORBA::Boolean marshal (const ::SSLIOP::Current_ptr p,TAO_OutputCDR & cdr);
  };
...
#define _TAO_TRANSPORT_IIOP_CURRENT__TRAITS_
  ...
  {
    static ::TAO::Transport::IIOP::Current_ptr duplicate (::TAO::Transport::IIOP::Current_ptr p);
    static void release (::TAO::Transport::IIOP::Current_ptr p);
    static ::TAO::Transport::IIOP::Current_ptr nil ();
    static ::CORBA::Boolean marshal (const ::TAO::Transport::IIOP::Current_ptr p,TAO_OutputCDR & cdr);
  };

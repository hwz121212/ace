...
#ifndef _TAO_PIDL_UINT8SEQC_4ODJTU_H_
#define _TAO_PIDL_UINT8SEQC_4ODJTU_H_
...
#define _CORBA_UINT8SEQ_CH_
  ...
  public:
    ...
    virtual ~UInt8Seq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = UInt8Seq_var;
    using _out_type = UInt8Seq_out;

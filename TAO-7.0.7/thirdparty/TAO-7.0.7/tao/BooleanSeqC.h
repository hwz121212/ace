...
#ifndef _TAO_PIDL_BOOLEANSEQC_XRFXUM_H_
#define _TAO_PIDL_BOOLEANSEQC_XRFXUM_H_
...
#define _CORBA_BOOLEANSEQ_CH_
  ...
  public:
    ...
    virtual ~BooleanSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = BooleanSeq_var;
    using _out_type = BooleanSeq_out;

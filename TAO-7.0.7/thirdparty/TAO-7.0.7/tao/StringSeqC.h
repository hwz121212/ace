...
#ifndef _TAO_PIDL_STRINGSEQC_6QXQXH_H_
#define _TAO_PIDL_STRINGSEQC_6QXQXH_H_
...
#define _CORBA_STRINGSEQ_CH_
  ...
  public:
    ...
    virtual ~StringSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = StringSeq_var;
    using _out_type = StringSeq_out;

...
void
TAO::Value_Traits<Messaging::ExceptionHolder>::add_ref (Messaging::ExceptionHolder * p)
{
  ::CORBA::add_ref (p);
}

void
TAO::Value_Traits<Messaging::ExceptionHolder>::remove_ref (Messaging::ExceptionHolder * p)
{
  ::CORBA::remove_ref (p);
}

void
TAO::Value_Traits<Messaging::ExceptionHolder>::release (Messaging::ExceptionHolder * p)
{
  ::CORBA::remove_ref (p);
}
...
const char *
Messaging::ExceptionHolder::_tao_obv_repository_id () const
{
...
// Retrieve the member
::CORBA::Boolean
OBV_Messaging::ExceptionHolder::is_system_exception () const
{
...
// Retrieve the member
::CORBA::Boolean
OBV_Messaging::ExceptionHolder::byte_order () const
{
  return this->_pd_byte_order;
}
// TAO_IDL - Generated from
// d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_visitor_valuetype\field_cs.cpp:754
...
OBV_Messaging::ExceptionHolder::marshaled_exception () const
{
...
CORBA::OctetSeq &
OBV_Messaging::ExceptionHolder::marshaled_exception ()
{
  return this->_pd_marshaled_exception;
}
// TAO_IDL - Generated from
...
void
OBV_Messaging::ExceptionHolder::truncation_hook ()
{

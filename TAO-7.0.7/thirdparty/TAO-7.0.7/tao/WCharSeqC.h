...
#ifndef _TAO_PIDL_WCHARSEQC_QFAABM_H_
#define _TAO_PIDL_WCHARSEQC_QFAABM_H_
...
#define _CORBA_WCHARSEQ_CH_
  ...
  public:
    ...
    virtual ~WCharSeq () = default;
    
    // TAO_IDL - Generated from
    // d:\hanwenzhi_code\ace\tao-7.0.7\thirdparty\tao-7.0.7\tao_idl\be\be_type.cpp:296

    
    using _var_type = WCharSeq_var;
    using _out_type = WCharSeq_out;

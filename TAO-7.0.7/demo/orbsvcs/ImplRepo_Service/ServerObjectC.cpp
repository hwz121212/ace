...
TAO::Objref_Traits<ImplementationRepository::AMI_ServerObjectHandler>::duplicate (ImplementationRepository::AMI_ServerObjectHandler_ptr p)
{
  return ImplementationRepository::AMI_ServerObjectHandler::_duplicate (p);
}

void
TAO::Objref_Traits<ImplementationRepository::AMI_ServerObjectHandler>::release (ImplementationRepository::AMI_ServerObjectHandler_ptr p)
{
  ::CORBA::release (p);
}

ImplementationRepository::AMI_ServerObjectHandler_ptr
TAO::Objref_Traits<ImplementationRepository::AMI_ServerObjectHandler>::nil ()
{
  return ImplementationRepository::AMI_ServerObjectHandler::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<ImplementationRepository::AMI_ServerObjectHandler>::marshal (const ImplementationRepository::AMI_ServerObjectHandler_ptr p,TAO_OutputCDR & cdr)
{
  return ::CORBA::Object::marshal (p, cdr);
}
...
ImplementationRepository::AMI_ServerObjectHandler_ptr
ImplementationRepository::AMI_ServerObjectHandler::_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TAO::Narrow_Utils<AMI_ServerObjectHandler>::narrow (_tao_objref, "IDL:ImplementationRepository/AMI_ServerObjectHandler:1.0");
}

ImplementationRepository::AMI_ServerObjectHandler_ptr
ImplementationRepository::AMI_ServerObjectHandler::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TAO::Narrow_Utils<AMI_ServerObjectHandler>::unchecked_narrow (_tao_objref);
}

ImplementationRepository::AMI_ServerObjectHandler_ptr
ImplementationRepository::AMI_ServerObjectHandler::_nil ()
{
  return nullptr;
}
...
ImplementationRepository::AMI_ServerObjectHandler::_is_a (const char *value)
{
  if (
      ...
      std::strcmp (value, "IDL:ImplementationRepository/AMI_ServerObjectHandler:1.0") == 0 ||
      std::strcmp (value, "IDL:omg.org/CORBA/Object:1.0") == 0
      )
    {
      return true; // success using local knowledge
...
const char* ImplementationRepository::AMI_ServerObjectHandler::_interface_repository_id () const
{
    ...
    ImplementationRepository::AMI_ServerObjectHandler_ptr &_tao_objref)
{
  ...
  // Narrow to the right type.
  _tao_objref = TAO::Narrow_Utils< ::ImplementationRepository::AMI_ServerObjectHandler>::unchecked_narrow (obj.in ());

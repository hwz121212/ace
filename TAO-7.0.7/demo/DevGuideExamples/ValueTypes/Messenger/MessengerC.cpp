...
void
TAO::Value_Traits<Message>::add_ref (Message * p)
{
  ::CORBA::add_ref (p);
}

void
TAO::Value_Traits<Message>::remove_ref (Message * p)
{
  ::CORBA::remove_ref (p);
}

void
TAO::Value_Traits<Message>::release (Message * p)
{
  ::CORBA::remove_ref (p);
}
...
const char *
Message::_tao_obv_repository_id () const
{
...
::CORBA::TypeCode_ptr Message::_tao_type () const
{
  return ::_tc_Message;
}
...
const char *
OBV_Message::user_ () const // get method
{
...
const char *
OBV_Message::subject_ () const // get method
{
...
const char *
OBV_Message::text_ () const // get method
{

...
TAO::Objref_Traits<DevGuide::Messenger>::duplicate (DevGuide::Messenger_ptr p)
{
  return DevGuide::Messenger::_duplicate (p);
}

void
TAO::Objref_Traits<DevGuide::Messenger>::release (DevGuide::Messenger_ptr p)
{
  ::CORBA::release (p);
}

DevGuide::Messenger_ptr
TAO::Objref_Traits<DevGuide::Messenger>::nil ()
{
  return DevGuide::Messenger::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<DevGuide::Messenger>::marshal (const DevGuide::Messenger_ptr p,TAO_OutputCDR & cdr)
{
...
DevGuide::Messenger_ptr
DevGuide::Messenger::_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TAO::Narrow_Utils<Messenger>::narrow (_tao_objref, "IDL:DevGuide/Messenger:1.0");
}

DevGuide::Messenger_ptr
DevGuide::Messenger::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TAO::Narrow_Utils<Messenger>::unchecked_narrow (_tao_objref);
}

DevGuide::Messenger_ptr
DevGuide::Messenger::_nil ()
{
  return nullptr;
}
...
{
  if (
      std::strcmp (value, "IDL:DevGuide/Messenger:1.0") == 0 ||
...
const char* DevGuide::Messenger::_interface_repository_id () const
{
...
void
TAO::Value_Traits<DevGuide::AMH_MessengerExceptionHolder>::add_ref (DevGuide::AMH_MessengerExceptionHolder * p)
{
  ::CORBA::add_ref (p);
}

void
TAO::Value_Traits<DevGuide::AMH_MessengerExceptionHolder>::remove_ref (DevGuide::AMH_MessengerExceptionHolder * p)
{
  ::CORBA::remove_ref (p);
}

void
TAO::Value_Traits<DevGuide::AMH_MessengerExceptionHolder>::release (DevGuide::AMH_MessengerExceptionHolder * p)
{
  ::CORBA::remove_ref (p);
}
...
const char *
DevGuide::AMH_MessengerExceptionHolder::_tao_obv_repository_id () const
{
...
::CORBA::TypeCode_ptr DevGuide::AMH_MessengerExceptionHolder::_tao_type () const
{
...
::CORBA::ValueBase *
DevGuide::AMH_MessengerExceptionHolder::_copy_value ()
{
...
void
DevGuide::AMH_MessengerExceptionHolder::raise_send_message ()
{
...
TAO::Objref_Traits<DevGuide::AMH_MessengerResponseHandler>::duplicate (DevGuide::AMH_MessengerResponseHandler_ptr p)
{
  return DevGuide::AMH_MessengerResponseHandler::_duplicate (p);
}

void
TAO::Objref_Traits<DevGuide::AMH_MessengerResponseHandler>::release (DevGuide::AMH_MessengerResponseHandler_ptr p)
{
  ::CORBA::release (p);
}

DevGuide::AMH_MessengerResponseHandler_ptr
TAO::Objref_Traits<DevGuide::AMH_MessengerResponseHandler>::nil ()
{
  return DevGuide::AMH_MessengerResponseHandler::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<DevGuide::AMH_MessengerResponseHandler>::marshal (const DevGuide::AMH_MessengerResponseHandler_ptr p,TAO_OutputCDR & cdr)
{
  return ::CORBA::Object::marshal (p, cdr);
}
...
DevGuide::AMH_MessengerResponseHandler::AMH_MessengerResponseHandler ()
{}void
...
DevGuide::AMH_MessengerResponseHandler_ptr
DevGuide::AMH_MessengerResponseHandler::_narrow (::CORBA::Object_ptr _tao_objref)
{
...
DevGuide::AMH_MessengerResponseHandler_ptr
DevGuide::AMH_MessengerResponseHandler::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return AMH_MessengerResponseHandler::_duplicate (
      dynamic_cast<AMH_MessengerResponseHandler_ptr> (_tao_objref));
}
...
DevGuide::AMH_MessengerResponseHandler_ptr
DevGuide::AMH_MessengerResponseHandler::_nil ()
{
  return nullptr;
}
...
{
  if (
      std::strcmp (value, "IDL:DevGuide/AMH_MessengerResponseHandler:1.0") == 0 ||
...
const char* DevGuide::AMH_MessengerResponseHandler::_interface_repository_id () const
{
...
OBV_DevGuide::AMH_MessengerExceptionHolder::AMH_MessengerExceptionHolder ()
    ...
    DevGuide::Messenger_ptr &_tao_objref)
{
  ...
  _tao_objref = TAO::Narrow_Utils< ::DevGuide::Messenger>::unchecked_narrow (obj.in ());
...
void
OBV_DevGuide::AMH_MessengerExceptionHolder::truncation_hook ()
{

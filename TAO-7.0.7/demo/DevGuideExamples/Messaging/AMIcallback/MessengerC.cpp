...
MessengerUnableToSendMessage::MessengerUnableToSendMessage ()
  : ::CORBA::UserException (
...
::CORBA::Exception *MessengerUnableToSendMessage::_alloc ()
{
  ::CORBA::Exception *retval {};
  ACE_NEW_RETURN (retval, ::MessengerUnableToSendMessage, nullptr);
  return retval;
}

::CORBA::Exception *
MessengerUnableToSendMessage::_tao_duplicate () const
{
  ::CORBA::Exception *result {};
  ACE_NEW_RETURN (result, ::MessengerUnableToSendMessage (*this), nullptr);
  return result;
}

void MessengerUnableToSendMessage::_raise () const
{
  throw *this;
}
...
::CORBA::TypeCode_ptr MessengerUnableToSendMessage::_tao_type () const
{
...
TAO::Objref_Traits<AMI_MessengerHandler>::duplicate (AMI_MessengerHandler_ptr p)
{
  return AMI_MessengerHandler::_duplicate (p);
}

void
TAO::Objref_Traits<AMI_MessengerHandler>::release (AMI_MessengerHandler_ptr p)
{
  ::CORBA::release (p);
}

AMI_MessengerHandler_ptr
TAO::Objref_Traits<AMI_MessengerHandler>::nil ()
{
  return AMI_MessengerHandler::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<AMI_MessengerHandler>::marshal (const AMI_MessengerHandler_ptr p,TAO_OutputCDR & cdr)
{
  return ::CORBA::Object::marshal (p, cdr);
}
...
AMI_MessengerHandler_ptr
AMI_MessengerHandler::_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TAO::Narrow_Utils<AMI_MessengerHandler>::narrow (_tao_objref, "IDL:AMI_MessengerHandler:1.0");
}

AMI_MessengerHandler_ptr
AMI_MessengerHandler::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TAO::Narrow_Utils<AMI_MessengerHandler>::unchecked_narrow (_tao_objref);
}

AMI_MessengerHandler_ptr
AMI_MessengerHandler::_nil ()
{
  return nullptr;
}
...
AMI_MessengerHandler::_is_a (const char *value)
{
  if (
      ...
      std::strcmp (value, "IDL:AMI_MessengerHandler:1.0") == 0 ||
      std::strcmp (value, "IDL:omg.org/CORBA/Object:1.0") == 0
      )
    {
      return true; // success using local knowledge
...
const char* AMI_MessengerHandler::_interface_repository_id () const
{
...
::CORBA::Boolean operator>>= (
  ...
  const MessengerUnableToSendMessage *&_tao_elem)
{
  return TAO::Any_Dual_Impl_T<MessengerUnableToSendMessage>::extract (
    _tao_any,
    MessengerUnableToSendMessage::_tao_any_destructor,
    _tc_MessengerUnableToSendMessage,
    _tao_elem);
    ...
    AMI_MessengerHandler_ptr &_tao_objref)
{
  ...
  // Narrow to the right type.
  _tao_objref = TAO::Narrow_Utils< ::AMI_MessengerHandler>::unchecked_narrow (obj.in ());
